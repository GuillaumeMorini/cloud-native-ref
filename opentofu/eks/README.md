...
| <a name="input_cilium_version"></a> [cilium\_version](#input\_cilium\_version) | Cilium cluster version | `string` | `"1.17.3"` | no |
...
| <a name="input_karpenter_version"></a> [karpenter\_version](#input\_karpenter\_version) | Karpenter version | `string` | `"1.4.0"` | no |
...
No outputs.
<!-- END_TF_DOCS -->
>>>>>>> 2d928f1 (chore(gapi): upgrade version 1.3.0)
